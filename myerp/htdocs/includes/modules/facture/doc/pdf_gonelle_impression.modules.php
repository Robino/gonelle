...
/**
 *	\file       htdocs/includes/modules/facture/doc/pdf_gonelle_impression.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate invoices from crab model
 *	\author	    Laurent Destailleur
 *	\version    $Id: pdf_gonelle_impression.modules.php,v 1.12 2011/07/31 23:28:15 eldy Exp $
 */
...
/**
 *	\class      pdf_gonelle_impression
 *	\brief      Classe permettant de generer les factures au modele gonelle_impression
 */

class pdf_gonelle_impression extends ModelePDFFactures
{
	 ...
	 */
	function pdf_gonelle_impression($db)
	{
		...
		$this->db = $db;
		$this->name = "gonelle_impression";
		$this->description = $langs->trans('PDFgonelle_impressionDescription');
...
//print "$this->marge_gauche, $tab_top-1, $this->page_largeur-$this->marge_gauche-$this->marge_droite, $height_note+1";exit;
	...
	function _pagefoot(&$pdf,$object,$outputlangs)
	{
        ...
        // Logo
		//$logo=$conf->mycompany->dir_output.'/logos/basdepage2.jpg';
		//$pdf->Image($logo, 0, 253, 210, 0);	// width=0 (auto), max heig
