...
/**
 *	\file       htdocs/includes/modules/propale/pdf_propale_gonelle_impression.modules.php
 *	\ingroup    propale
 *	\brief      Fichier de la classe permettant de generer les propales au modele gonelle_impression
 *	\author	    Laurent Destailleur
 *	\version    $Id: pdf_propale_gonelle_impression.modules.php,v 1.243 2011/07/31 23:28:16 eldy Exp $
 */
...
/**
 *	\class      pdf_propale_gonelle_impression
 *	\brief      Classe permettant de generer les propales au modele gonelle_impression
 */
class pdf_propale_gonelle_impression extends ModelePDFPropales
{
	 ...
	 */
	function pdf_propale_gonelle_impression($db)
	{
		...
		$this->description = $langs->trans('DocModelgonelle_impressionDescription');
	...
	function write_file($object,$outputlangs,$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0)
	{
		...
		if ($conf->propale->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				$tab_top_newpage = 60;
				$tab_height = 110; //-VMO- Support du logo du bas
